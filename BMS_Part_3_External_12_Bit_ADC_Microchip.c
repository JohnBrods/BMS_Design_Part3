...
unsigned char VoltageSampleHigh;
unsigned char VoltageSampleLow;
...
void main(){
  ...
  while(1){
          ...
          BatteryVoltage = (VoltageSampleHigh << 8) + VoltageSampleLow;
           
          BatteryVoltage = 0.0012158203125 * BatteryVoltage;        //4.980 is voltage from 5 volt regulator to Microchip ADC
           
          //Write_Number(BatteryVoltage,20,40,lime);

          Write_Float_Number(BatteryVoltage,20,80,Yellow);  //My new float
